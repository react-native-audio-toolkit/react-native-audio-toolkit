...
var audioUtils = {
    getResourceUri: function(name, callback) {
        RCTAudioPlayer.getResourceUri(name, callback);
    },
    getExternalStorageUri: function(name, callback) {
        RCTAudioPlayer.getExternalStorageUri(name, callback);
    }
}

export { Player, audioUtils };
